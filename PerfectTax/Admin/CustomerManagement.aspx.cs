...
namespace PerfectTax.Admin
{
    public partial class CustomerManagement : System.Web.UI.Page
    {
        ...
        {
            PHLCustomerManagment.Visible = true;
            PHLAddCustomer.Visible = false;
        }
       
        protected void AddBtn_Click(object sender, EventArgs e)
        {
            PHLAddCustomer.Visible = true;
            PHLCustomerManagment.Visible = false;
        }
        ...
        protected void AddCustomer_Click(object sender, EventArgs e)
        {
            ...
            cmd.ExecuteNonQuery();
            string display = "Customer Details Added Successfully";
